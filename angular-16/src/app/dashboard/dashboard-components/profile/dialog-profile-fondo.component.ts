...
@Component({
  selector: 'app-dialog-profile-fondo',
  templateUrl: './dialog-profile-fondo.component.html',
  styleUrls: ['./dialog-profile-fondo.component.scss']
})
export class DialogProfileFondoComponent {
  public imgUrl = '';
  user!: Usuario;
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.fileUploadService
          ...
          .then((img) => {
            this.user.img = img;
            Swal.fire('Guardado!', 'Imagen de fondo actualizada.', 'success');
            location.reload();
          })
          .catch((err) => {
            console.log(err);
